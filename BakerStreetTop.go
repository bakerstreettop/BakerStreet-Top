...
func init() {
	...
	http.Handle("/bbs/", http.FileServer(http.Dir("Visity")));
	http.Handle("/blog/", http.FileServer(http.Dir("Visity")));
	http.Handle("/game/", http.FileServer(http.Dir("Visity")));
	http.Handle("/material/", http.FileServer(http.Dir("Visity")));
	http.Handle("/tool/", http.FileServer(http.Dir("Visity")));
	http.Handle("/library/", http.FileServer(http.Dir("Visity")));
